 ...
 *
 * File: proj3_test.c
 * Description: test different page allocators
 *
 *
*/
...
main(int argc, char *argv[])
{
    ...
    *addr = 1;
    ...
    printf(1, "\n=========== TEST 6: directly write to an unallocated page ===========\n", addr);
    cur_break = sbrk(0);
    printf(1, "Before the write, break 0x%x ", cur_break);
    print_free_frame_cnt();
    addr = cur_break + 4096;
